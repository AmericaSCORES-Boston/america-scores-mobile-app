...
export default {
    ...
    tabActiveBgColor: (Platform.OS=='ios') ? '#cde1f9' : '#4179F7',
    ...
    // Line Height
    btnLineHeight: 19,
    lineHeightH1: this.fontSizeH1 * 2,
    lineHeightH2: this.fontSizeH2 * 2,
    lineHeightH3: this.fontSizeH3 * 1.5,
